...
<form class="form form-horizontal" action="{{route('stylists.update', $stylist->id)}}" enctype="multipart/form-data"
    method="put">
    @csrf
    @method('PUT')
    ...
    <div class="form-group">
        ...
        <input type="text" name="contact_phone" id="contact_phone" class="form-control" value="{{$stylist->contact_phone}}">
        @error('contact_phone')
        <div class="alert alert-danger">
            <p>{{$message}}</p>
        </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="contact_email" id="contact_email" class="form-control" value="{{$stylist->contact_email}}">
        @error('contact_email')
        <div class="alert alert-danger">
            <p>{{$message}}</p>
        </div>
